...
export default function EditWatch({watch}){
    ...
    return (
        <div>
            <button onClick={() => setShowModal(true)} className="px-4 py-2 font-bold text-white bg-blue-500 rounded hover:bg-blue-700">
                Edit
            </button>
            {showModal && (
                <div className="fixed inset-0 flex items-center justify-center px-4 bg-gray-800 bg-opacity-75">
                    ...
                    <span className="float-right text-xl leading-none text-white cursor-pointer close hover:text-gray-300" onClick={() => setShowModal(false)}>&times;</span>
                    <form action={updateWatch} onSubmit={() => setShowModal(false)} className="mt-4">
                        ...
                        />
                        <div className="mb-4">
                            <label htmlFor="brand" className="block mb-2 text-gray-300">Brand</label>
                            <input 
                                type="text" 
                                id="brand"
                                name="brand" 
                        ...
                        <div className="mb-4">
                            <label htmlFor="model" className="block mb-2 text-gray-300">Model</label>
                            <input 
                                type="text" 
                                id="model"
                                name="model" 
                        ...
                        <div className="mb-4">
                            <label htmlFor="referenceNumber" className="block mb-2 text-gray-300">Reference Number</label>
                            <input 
                                type="text" 
                                id="referenceNumber"
