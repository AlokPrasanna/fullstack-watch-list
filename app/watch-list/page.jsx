        ...
        <div className="min-h-screen text-gray-300 bg-gray-900">
            <div className="container p-6 mx-auto sm:p-12">
                <div className="flex items-start justify-between">
                    <h1 className="mb-6 text-5xl font-extrabold text-white md:text-6xl">My Watch List</h1>
                ...
                <div className="mt-6">
                    {watches.map((watch) => (
                        <div key={watch.id} className="p-4 mb-4 bg-gray-800 rounded-lg shadow">
                        <h2 className="mb-2 text-xl text-white">{watch.brand} - {watch.model}</h2>
